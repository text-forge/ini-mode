# Text Forge INI mode
Official INI mode for Text Forge code editor

---

INI Mode is a lightweight and functional mode for Text Forge code editor. It's a part of official Text Forge modes.

## Mode Features
- Updated to [Text Forge Mode API V2.0](https://github.com/text-forge/text-forge/pull/71)
- Smart outline system with section and keys
- Smart auto format
...
- Download `ini.tfmode` file from releases. 
